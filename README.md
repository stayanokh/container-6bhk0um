...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-6bhk0um.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-6bhk0um.containers.anotherwebservice.com/
...
```
git clone git@github.com:stayanokh/container-6bhk0um.git
cd container-6bhk0um
```
...
```
docker attach container-6bhk0um
```
